 ...
 *     .claim("https://example.com/is_root", true)
 *     .build();
 * </pre>
 *
...
public final class JWTClaimsSet implements Serializable {
        ...
        public static class Builder {
                 ...
                 * @return This builder.
                 */
                public Builder expirationInstant(final Instant exp) {
                 ...
                 * @return This builder.
                 */
                public Builder notBeforeInstant(final Instant nbf) {
                 ...
                 * @return This builder.
                 */
                public Builder issueInstant(final Instant iat) {
        ...
        public Instant getNotBeforeInstant() {
                try {
                        return getInstantClaim(JWTClaimNames.NOT_BEFORE);
                } catch (ParseException e) {
                        return null;
                }
        }
        ...
        /**
         * Gets the specified claim (registered or custom) as
         * {@link java.time.Instant}. The claim may be represented by a Date
         * object, an Instant object, or a number of seconds since the Unix
         * epoch.
         *
         * @param name The name of the claim. Must not be {@code null}.
         *
         ...
         *                        type.
         */
        public Instant getInstantClaim(final String name)
                throws ParseException {
                Object value = getClaim(name);
                if (value == null) {
                        return null;
                        ...
                        throw new ParseException("The \"" + name + "\" claim is not a Date/Instant", 0);
                }
        }
        ...
        public Date getDateClaim(final String name)
                throws ParseException {
                Instant value = getInstantClaim(name);
                if (value == null) {
                        return null;
                } else {
        ...
        public Map<String, Object> toJSONObject(final boolean serializeNullClaims) {
                ...
                for (Map.Entry<String, Object> claim : claims.entrySet()) {
                        if (claim.getValue() instanceof Instant) {
                                // Transform instances to Unix timestamps
                                Instant instantValue = (Instant) claim.getValue();
                                o.put(claim.getKey(), instantValue.getEpochSecond());
        ...
        public boolean equals(Object o) {
                // Serialize nulls flag ignored in equality check, only claims matter
